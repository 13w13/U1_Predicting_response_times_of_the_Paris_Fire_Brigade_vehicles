...
x_test1 <- read.csv("x_test.csv") %>% setDT
#View(x_train)
...
```{r}
id_order<-data.frame(x_test1$emergency.vehicle.selection)
```
...
```{r}
y_final<-merge(id_order,pred_final, by.x = "x_test1.emergency.vehicle.selection", by.y ="id", all = FALSE,sort=FALSE)
```
