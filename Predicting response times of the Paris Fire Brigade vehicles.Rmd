...
```{r}
importance_matrix <- xgb.importance(model = gb_dt)
...
```{r}
pred_xgboost_y0 <- predict(gb_dt,dtest)
```
...
```{r}
pred_xgboost_y1 <- predict(gb_dt,dtest)
```
