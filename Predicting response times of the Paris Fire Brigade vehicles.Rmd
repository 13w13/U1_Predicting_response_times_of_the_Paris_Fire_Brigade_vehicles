...
We find a linear correlation between y1 and OSRM estiamted estimated time and distance (which seems to be normal)
...
diff between estiamted duration and delta selection.presentation
