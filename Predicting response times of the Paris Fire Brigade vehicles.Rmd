...
vif(lm)
```
Except for OSRM data, no high correlated coef. We decide to keep them as they are important for our model. 




#### 6.2.4 Residuals analysis
...
pred_xgboost=data.frame(pred_reg_y0,pred_reg_y1,pred_reg_ys)
...
### 7 Actual predict [if time]


Now that we have our models, we can use predict for x_test as challenge request. 
