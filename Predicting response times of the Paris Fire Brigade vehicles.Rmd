...
```{r}
fwrite(y_final, "t.csv",sep=",")
```

```{r}
y_final[y_final$`delta.departure.selection`==0]
```


```{r}
write.csv(y_final,"C:/Users/swp/Documents/_Perso/Cours/M2/U1. Analytical Theory, Methods and Models/Econometrics and Statitical Models/0.Project/y_test.csv",sep=",",row.names=y_final$order_x_test.emergency.vehicle.selection)
```
